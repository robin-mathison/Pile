...
Navigate to main Pile directory. 
Run python3 -m venv <name of venv here>
(Note that the last argument will be the name of the newly created virtual environment directory.)

This creates the necessary files for your Flask project's venv. 
...
Navigate to Pile/src/UI_Integrations
